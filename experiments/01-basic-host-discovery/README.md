...
```text
192.168.100.20 → 08:00:27:F2:C0:4E
```
...
## 📸 [Evidence](https://github.com/harikrishnan-rk/nmap-wireshark-network-analysis/tree/main/experiments/01-basic-host-discovery/evidence)
